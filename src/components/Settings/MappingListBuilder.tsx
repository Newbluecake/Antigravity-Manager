...
import GroupedSelect, { SelectOption } from '../common/GroupedSelect';
...
export default function MappingListBuilder({ value, onChange, modelOptions }: MappingListBuilderProps) {
